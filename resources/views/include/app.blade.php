...
<head>
    ...
    <style>
        :root {
            ...
            /* Sidebar Overrides */
            --ct-menu-bg: #0f172a;
            --ct-menu-item-color: #94a3b8;
            --ct-menu-item-hover-color: #6366f1;
        ...
        .side-nav-link {
            color: var(--ct-menu-item-color) !important;
            font-weight: 500;
        ...
        .side-nav-item > .side-nav-link.active {
            color: var(--ct-menu-item-active-color) !important;
            background: linear-gradient(90deg, rgba(79, 70, 229, 0.15) 0%, rgba(79, 70, 229, 0) 100%) !important;
        ...
        .side-nav-item > .side-nav-link.active i {
        ...
        .logo-topbar, .leftside-menu .logo {
        ...
        <div class="leftside-menu">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    {{-- Hashtags --}}
                    <li class="side-nav-item hashtags">
                        <a href="{{ url('hashtags')}}" class="side-nav-link">
                    ...
                    <li class="side-nav-item restrictions">
                      ...
                      {{-- Reports --}}
                      <li class="side-nav-item reports">
                      ...
                      {{-- Dummy Lives --}}
                      <li class="side-nav-item dummyLives">
                        <a href="{{ url('dummyLives')}}" class="side-nav-link">
                            <i class="uil-selfie"></i>
                            <span> {{ __('Dummy Lives')}} </span>
                        </a>
                    </li>
                    <li class="side-nav-title">{{ __('settings')}}</li>
                    <li class="side-nav-item languages">
                        <a href="{{ url('languages') }}" class="side-nav-link ">
                            <i class="ri-translate-2 font-22"></i>
